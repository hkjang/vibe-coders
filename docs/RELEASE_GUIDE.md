...
```powershell
# 스크립트를 사용하여 릴리즈 업로드
pwsh -File scripts/gh_release.ps1 -Version v0.1.6
```
...
gh release create v0.1.6 \
  "release/ai-coding-proxy-gateway-v0.1.6.tar.gz" \
  "release/ai-coding-proxy-gateway-v0.1.6.tar.gz.sha256" \
  "release/README-offline-v0.1.6.md" \
  --repo hkjang/vibe-coders \
  --title "v0.1.6 - AI Coding Proxy Gateway" \
...
```powershell
gh release view v0.1.6 --repo hkjang/vibe-coders
```
