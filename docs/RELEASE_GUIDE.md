...
gh release create v0.1.11 \
  "release/ai-coding-proxy-gateway-v0.1.11.tar.gz" \
  "release/ai-coding-proxy-gateway-v0.1.11.tar.gz.sha256" \
  "release/README-offline-v0.1.11.md" \
  --repo hkjang/vibe-coders \
  --title "v0.1.11 - AI Coding Proxy Gateway" \
...
```powershell
gh release view v0.1.11 --repo hkjang/vibe-coders
```
