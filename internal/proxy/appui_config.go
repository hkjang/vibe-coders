...
var appUIFeatures = []appUIFeature{
	{FeatureID: "overview", Title: "통합 현황", AppPath: "/app/overview", LegacyPath: "/admin#/dashboard", Status: "preview_read_only", RiskLevel: "low", RequiredPermission: "admin:read", ReadOnly: true, EnabledRoles: []string{"super_admin", "admin", "ops_admin", "ai_admin", "security_admin", "billing_admin", "readonly_admin", "viewer"}, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.80.0"},
	{FeatureID: "me.home", Title: "내 홈", AppPath: "/app/me", LegacyPath: "/admin#/me", Status: "preview", RiskLevel: "low", RequiredPermission: "", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "team.home", Title: "팀 대시보드", AppPath: "/app/team", LegacyPath: "/admin#/team", Status: "preview", RiskLevel: "low", RequiredPermission: "team:read", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "gateway.health", Title: "게이트웨이 상태", AppPath: "/app/gateway/health", LegacyPath: "/admin#/routing/health", Status: "preview", RiskLevel: "low", RequiredPermission: "routing:read", ReadOnly: false, EnabledRoles: []string{"super_admin", "admin", "ai_admin"}, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "gateway.providers", Title: "AI 공급자", AppPath: "/app/gateway/providers", LegacyPath: "/admin#/settings", Status: "preview", RiskLevel: "medium", RequiredPermission: "admin:read", ReadOnly: false, EnabledRoles: []string{"super_admin", "admin", "ai_admin"}, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "gateway.models", Title: "모델", AppPath: "/app/gateway/models", LegacyPath: "/admin#/model-contracts", Status: "preview", RiskLevel: "medium", RequiredPermission: "admin:read", ReadOnly: false, EnabledRoles: []string{"super_admin", "admin", "ai_admin"}, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "gateway.chat", Title: "Chat 테스트", AppPath: "/app/gateway/chat", LegacyPath: "/admin#/chat-test", Status: "preview", RiskLevel: "medium", RequiredPermission: "admin:read", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "routing.rules", Title: "라우팅", AppPath: "/app/routing/rules", LegacyPath: "/admin#/routing", Status: "preview", RiskLevel: "high", RequiredPermission: "routing:read", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	...
	{FeatureID: "observability.sessions", Title: "세션 비행기록", AppPath: "/app/observability/sessions", LegacyPath: "/admin#/sessions", Status: "preview", RiskLevel: "low", RequiredPermission: "admin:read", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "observability.xview", Title: "XView 실시간", AppPath: "/app/observability/xview", LegacyPath: "/admin#/xview", Status: "preview", RiskLevel: "low", RequiredPermission: "admin:read", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "observability.llm", Title: "LLM 관측", AppPath: "/app/observability/llm", LegacyPath: "/admin#/llm", Status: "preview", RiskLevel: "low", RequiredPermission: "admin:read", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "observability.probes", Title: "진단 프로브", AppPath: "/app/observability/probes", LegacyPath: "/admin#/journey-probe", Status: "preview", RiskLevel: "low", RequiredPermission: "admin:read", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "prompts.lab", Title: "프롬프트 실험실", AppPath: "/app/prompts/lab", LegacyPath: "/admin#/prompt-lab", Status: "preview", RiskLevel: "medium", RequiredPermission: "admin:read", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "prompts.library", Title: "프롬프트 라이브러리", AppPath: "/app/prompts/library", LegacyPath: "/admin#/prompts", Status: "preview", RiskLevel: "medium", RequiredPermission: "admin:read", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "access.users", Title: "사용자와 팀", AppPath: "/app/access/users", LegacyPath: "/admin#/users", Status: "preview", RiskLevel: "medium", RequiredPermission: "admin:read", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "governance.policies", Title: "정책 및 거버넌스", AppPath: "/app/governance/policies", LegacyPath: "/admin#/safety", Status: "preview", RiskLevel: "high", RequiredPermission: "security:read", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "governance.remediation", Title: "자동 조치", AppPath: "/app/governance/remediation", LegacyPath: "/admin#/remediation", Status: "preview", RiskLevel: "high", RequiredPermission: "admin:read", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "governance.reports", Title: "운영 리포트", AppPath: "/app/governance/reports", LegacyPath: "/admin#/scorecard", Status: "preview", RiskLevel: "low", RequiredPermission: "admin:read", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "governance.assets", Title: "AI 자산", AppPath: "/app/governance/assets", LegacyPath: "/admin#/sbom", Status: "preview", RiskLevel: "medium", RequiredPermission: "admin:read", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "mcp.overview", Title: "MCP 및 에이전트", AppPath: "/app/mcp", LegacyPath: "/admin#/mcp", Status: "preview", RiskLevel: "medium", RequiredPermission: "admin:read", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "mcp.gateway", Title: "Gateway MCP", AppPath: "/app/mcp-gateway", LegacyPath: "/admin#/gateway-mcp", Status: "preview", RiskLevel: "medium", RequiredPermission: "admin:read", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "agents.registry", Title: "에이전트", AppPath: "/app/agents/registry", LegacyPath: "/admin#/agents", Status: "preview", RiskLevel: "medium", RequiredPermission: "admin:read", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "agents.workflows", Title: "워크플로", AppPath: "/app/agents/workflows", LegacyPath: "/admin#/workflows", Status: "preview", RiskLevel: "medium", RequiredPermission: "admin:read", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "agents.apps", Title: "AI 업무 앱", AppPath: "/app/agents/apps", LegacyPath: "/admin#/apps", Status: "preview", RiskLevel: "medium", RequiredPermission: "admin:read", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "agents.skills", Title: "Skill", AppPath: "/app/agents/skills", LegacyPath: "/admin#/skills", Status: "preview", RiskLevel: "medium", RequiredPermission: "admin:read", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "text2sql.overview", Title: "Text2SQL 및 데이터", AppPath: "/app/text2sql", LegacyPath: "/admin#/text2sql", Status: "preview", RiskLevel: "high", RequiredPermission: "admin:read", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "data.warehouse", Title: "DW 대시보드", AppPath: "/app/data/warehouse", LegacyPath: "/admin#/dwdashboard", Status: "preview", RiskLevel: "medium", RequiredPermission: "admin:read", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "data.products", Title: "데이터 상품", AppPath: "/app/data/products", LegacyPath: "/admin#/data-products", Status: "preview", RiskLevel: "medium", RequiredPermission: "admin:read", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "finops.overview", Title: "비용 관리", AppPath: "/app/finops", LegacyPath: "/admin#/billing", Status: "preview", RiskLevel: "medium", RequiredPermission: "costs:read", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "security.overview", Title: "보안", AppPath: "/app/security", LegacyPath: "/admin#/security", Status: "preview", RiskLevel: "high", RequiredPermission: "security:read", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "security.redteam", Title: "Red Team", AppPath: "/app/redteam", LegacyPath: "/admin#/redteam", Status: "preview", RiskLevel: "high", RequiredPermission: "security:read", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "security.sandbox", Title: "민감 샌드박스", AppPath: "/app/sandbox", LegacyPath: "/admin#/sandbox", Status: "preview", RiskLevel: "high", RequiredPermission: "admin:read", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
	{FeatureID: "system.health", Title: "시스템 상태", AppPath: "/app/system/health", LegacyPath: "/admin#/ops-home", Status: "preview_read_only", RiskLevel: "low", RequiredPermission: "admin:read", ReadOnly: true, EnabledRoles: []string{"super_admin", "admin", "ops_admin", "ai_admin", "security_admin", "billing_admin", "readonly_admin"}, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.81.0"},
	{FeatureID: "system.settings", Title: "시스템 설정", AppPath: "/app/system/settings", LegacyPath: "/admin#/settings", Status: "preview", RiskLevel: "critical", RequiredPermission: "admin:read", ReadOnly: false, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.84.0"},
}

// appUIImplementedFeatureIDs lists the features this build ships a React screen for.
// It is the server-side half of the same capability boundary the UI enforces in
// src/features/registry.ts: a runtime setting must never promote a route no screen owns.
