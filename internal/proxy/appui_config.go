...
var appUIFeatures = []appUIFeature{
	...
	{FeatureID: "gateway.health", Title: "게이트웨이 상태", AppPath: "/app/gateway/health", LegacyPath: "/admin#/routing/health", Status: "preview_read_only", RiskLevel: "low", RequiredPermission: "routing:read", ReadOnly: true, EnabledRoles: []string{"super_admin", "admin", "ai_admin"}, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.81.0"},
	...
	{FeatureID: "mcp.overview", Title: "MCP 및 에이전트", AppPath: "/app/mcp", LegacyPath: "/admin#/mcp", Status: "legacy", RiskLevel: "medium", RequiredPermission: "admin:read", ReadOnly: true, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.80.0"},
	...
	{FeatureID: "text2sql.overview", Title: "Text2SQL 및 데이터", AppPath: "/app/text2sql", LegacyPath: "/admin#/text2sql", Status: "legacy", RiskLevel: "high", RequiredPermission: "admin:read", ReadOnly: true, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.80.0"},
	...
	{FeatureID: "finops.overview", Title: "비용 관리", AppPath: "/app/finops", LegacyPath: "/admin#/billing", Status: "legacy", RiskLevel: "medium", RequiredPermission: "costs:read", ReadOnly: true, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.80.0"},
	{FeatureID: "security.overview", Title: "보안", AppPath: "/app/security", LegacyPath: "/admin#/security", Status: "legacy", RiskLevel: "high", RequiredPermission: "security:read", ReadOnly: true, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.80.0"},
	...
	{FeatureID: "system.settings", Title: "시스템 설정", AppPath: "/app/system/settings", LegacyPath: "/admin#/settings", Status: "legacy", RiskLevel: "critical", RequiredPermission: "admin:read", ReadOnly: true, RolloutPercent: 100, FallbackEnabled: true, MinimumAPIVersion: "v0.80.0"},
}
