...
var menuRegistry = []menuItem{
	...
	{ID: "ops.workflows", Label: "워크플로", Path: "#/workflows", Tab: "workflows", Group: "ops", Scopes: []string{"admin:read"}, DataScope: "all"},
	...
	{ID: "sec.privacy_ledger", Label: "프라이버시 원장", Path: "#/privacy-ledger", Tab: "privacy-ledger", Group: "security", Scopes: []string{"security:read"}, DataScope: "all"},
	{ID: "ops.productivity", Label: "AI 업무성과", Path: "#/productivity", Tab: "productivity", Group: "ops", Scopes: []string{"admin:read"}, DataScope: "all"},
	...
	{ID: "ops.skill_graph", Label: "Skill 의존성", Path: "#/skill-graph", Tab: "skill-graph", Group: "ops", Scopes: []string{"admin:read"}, DataScope: "all"},
	{ID: "bill.chargeback", Label: "비용 배부 팩", Path: "#/chargeback", Tab: "chargeback", Group: "billing", Scopes: []string{"admin:read"}, DataScope: "all"},
	{ID: "ops.prompt_debt", Label: "프롬프트 부채", Path: "#/prompt-debt", Tab: "prompt-debt", Group: "ops", Scopes: []string{"admin:read"}, DataScope: "all"},
