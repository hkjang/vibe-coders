...
describe("migration registry", () => {
  const serverContract = [
    ...
    ["observability.sessions", "/app/observability/sessions"],
    ["observability.xview", "/app/observability/xview"],
    ["observability.llm", "/app/observability/llm"],
    ["observability.probes", "/app/observability/probes"],
    ["prompts.lab", "/app/prompts/lab"],
    ["prompts.library", "/app/prompts/library"],
    ["access.users", "/app/access/users"],
    ["governance.policies", "/app/governance/policies"],
    ["governance.remediation", "/app/governance/remediation"],
    ["governance.reports", "/app/governance/reports"],
    ["governance.assets", "/app/governance/assets"],
    ["mcp.overview", "/app/mcp"],
    ["mcp.gateway", "/app/mcp-gateway"],
    ["agents.registry", "/app/agents/registry"],
    ["agents.workflows", "/app/agents/workflows"],
    ["agents.apps", "/app/agents/apps"],
    ...
    ["security.redteam", "/app/redteam"],
    ["security.sandbox", "/app/sandbox"],
